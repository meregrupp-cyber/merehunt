...
Repo → **Settings** → vasakul **Pages** → **Source:** `GitHub Actions`. Salvestamist ei ole vaja.

Seda sammu ei saa workflow ise ära teha: `GITHUB_TOKEN` tohib Pages'i deploy'da, aga mitte saiti
luua — `configure-pages` `enablement: true` vastab veaga
