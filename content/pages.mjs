...
<section class="band legacy-intro" aria-labelledby="legacy-title">
  <div class="inner legacy-note">
    ...
    <div>
      <p class="eyebrow">Для посетителей прежнего Merehunt</p>
      <h2 id="legacy-title">Merehunt изменился</h2>
      <p>Раньше на merehunt.ee работали магазин и форум о подводной охоте. Сейчас здесь — обучение фридайвингу в Эстонии на русском и английском. Магазин и старый форум больше не работают.</p>
      <a class="text-link" href="/merehunt/">Что изменилось <span aria-hidden="true">→</span></a>
    </div>
  </div>
</section>
...
<section class="band summary-band" aria-labelledby="legacy-history-title">
  <div class="inner narrow">
    <p class="eyebrow">История домена</p>
    <h2 id="legacy-history-title">Старый магазин и форум закрыты</h2>
    <p class="lede">Merehunt был известен русскоязычному сообществу подводной охоты как магазин снаряжения и форум для совместных выездов. Сейчас этот адрес посвящён обучению фридайвингу в Эстонии.</p>
    <p>Мы сохранили знакомый домен, чтобы прежний посетитель не попадал на пустую или постороннюю страницу. Здесь нет действующего магазина, каталога, старых учётных записей и архива форума.</p>
  </div>
</section>

<section class="band band-alt" aria-labelledby="legacy-difference-title">
  <div class="inner">
    <p class="eyebrow">Похожая среда · другая задача</p>
    <h2 id="legacy-difference-title">Фридайвинг и подводная охота — не одно и то же</h2>
    <div class="two-column">
      <article class="panel"><h3>Фридайвинг</h3><p>Ныряние с задержкой дыхания, где основное внимание уделяется технике, расслаблению, компенсации давления, работе с напарником и постепенному развитию навыков.</p></article>
      <article class="panel"><h3>Подводная охота</h3><p>Использует часть похожих водных навыков, но имеет другую цель, правила и снаряжение. На merehunt.ee больше нет магазина или программы по подводной охоте.</p></article>
    </div>
  </div>
</section>
...
<section class="band safety-band" aria-labelledby="legacy-next-title">
  <div class="inner">
    <p class="eyebrow">Куда идти дальше</p>
    <h2 id="legacy-next-title">Выберите по своей подготовке</h2>
    ${routeCards()}
  </div>
</section>

${directContact('Merehunt — вопрос о фридайвинге', 'Не нашли то, что искали?', 'Если вы пришли по старой ссылке, напишите, что именно искали. Мы честно подскажем, относится ли это к нынешним занятиям по фридайвингу.')}`;
...
export const pages = Object.freeze([
  ...
  },
  {
    ...
    schemaType: 'WebPage',
    updated: UPDATED,
    title: 'Merehunt: бывший магазин и форум — теперь фридайвинг в Эстонии',
    description: 'Merehunt раньше был магазином и форумом о подводной охоте. Сейчас merehunt.ee — курсы и практика фридайвинга в Эстонии на русском и английском.',
    ogDescription: 'Что изменилось на merehunt.ee и как прежнему посетителю выбрать подходящий путь во фридайвинге.',
    eyebrow: 'Merehunt · новая глава',
    h1: 'Merehunt: от подводной охоты <em>к фридайвингу</em>',
    lede: 'Старые магазин и форум больше не работают. На знакомом домене теперь находится самостоятельный сайт обучения фридайвингу в Эстонии.',
    heroImage: '/assets/images/freediver-depth-blue.webp',
    heroAlt: '',
    primaryCta: { href: '/kurs-fridajvinga/', label: 'Начать с курса' },
    secondaryCta: { href: '#legacy-next-title', label: 'Выбрать направление' },
    body: legacyBody,
  },
]);
